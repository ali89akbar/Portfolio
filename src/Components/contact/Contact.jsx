...
const Contact = () => {
    ...
    const isinView = useInView(ref, { margin: "-100px",opacity:0});
    ...
    const sendEmail = (e) => {
        ...
        const emailData = {
            service_id: 'service_aox57ec', // Ensure this is correct
            template_id: 'template_pmpoa2j', // Update this with the correct template ID
            user_id: 'u0bSgZGy-RB7otOh0', // Ensure this is correct
            template_params: {
        ...
        <motion.div className='contact' variants={variants} initial="initial" animate="animate">
            <motion.div className="textcontainer" variants={variants}>
                ...
                <motion.div className="item" variants={variants}>
                    <h2>Mail</h2>
                    <span>alia42268@gmail.com</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Address</h2>
                    <span>Fb Area Karachi</span>
                </motion.div>
                <motion.div className="item" variants={variants}>
                    <h2>Phone</h2>
                    <span>+923312035946</span>
                </motion.div>
            </motion.div>
            <div className="formcontainer">
                ...
                >
<svg fill="#000000" width="500px" height="500px" viewBox="0 0 64 64" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<g id="_x30_1_chatting"/>
                ...
                >
                    ...
                    {error && <div className="error-message">Error sending email</div>}
